# [Ansible role turn](#ansible-role-turn)

Install and configure a (co) turn server on your system.

|GitHub|Issues|Pull Requests|Version|Downloads|
|------|------|-------------|-------|---------|
|[![github](https://github.com/buluma/ansible-role-turn/actions/workflows/molecule.yml/badge.svg)](https://github.com/buluma/ansible-role-turn/actions/workflows/molecule.yml)|[![Issues](https://img.shields.io/github/issues/buluma/ansible-role-turn.svg)](https://github.com/buluma/ansible-role-turn/issues/)|[![PullRequests](https://img.shields.io/github/issues-pr-closed-raw/buluma/ansible-role-turn.svg)](https://github.com/buluma/ansible-role-turn/pulls/)|[![Version](https://img.shields.io/github/release/buluma/ansible-role-turn.svg)](https://github.com/buluma/ansible-role-turn/releases/)|[![Ansible Role](https://img.shields.io/ansible/role/d/buluma/turn)](https://galaxy.ansible.com/ui/standalone/roles/buluma/turn/documentation)|
...
turn_server_name: "{{ ansible_facts['fqdn'] }}"
turn_listening_ip: "{{ ansible_facts['default_ipv4'].address }}"
turn_external_ip: "{{ ansible_facts['default_ipv4'].address }}"
```
...
If you find issues, please register them on [GitHub](https://github.com/buluma/ansible-role-turn/issues).
